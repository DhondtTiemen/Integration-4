      ...
      <div class="p-6 space-y-6">
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          <div>
            ...
            <input v-model="username" type="username" id="username" placeholder="JohnD" required
          ...
          <div class="flex items-start">
            <div class="flex items-center h-5">
              <input v-model="acceptedTerms" id="terms" type="checkbox" required
                class="appearance-none w-4 h-4 border border-alphaDark focus:ring-3 focus:ring-alphaDark" />
            </div>
            <div class="ml-3 text-sm">
              <label for="terms" class="font-light text-alphaDark">
                I accept the <a href="https://www.kortrijk.be/privacyverklaring" class="font-medium text-alphaDark hover:underline dark:text-primary-500">Privacy Policy</a>
              </label>
            </div>
          </div>
          <div class="flex items-start mb-6">
            ...
            <div class="ml-3 text-sm">
              <label for="terms" class="font-light text-alphaDark">
                I want to subscribe to the <span class="font-medium text-alphaDark hover:underline dark:text-primary-500">newsletter</span>
              </label>
            </div>
          </div>
          ...
          <p class="text-sm font-light">
            ...
            <a href="#" class="font-medium text-alphaGreen underline dark:text-primary-500">Login here</a>
          </p>
        </form>
      </div>
    </div>
