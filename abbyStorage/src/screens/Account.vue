<template>
  <div v-bind="$attrs">
    <div class="bg-alphaYellow">
      ...
      >
        <button @click="goBack">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-auto" viewBox="0 0 21 18" fill="none">
            <path d="M21 6.07521L4.34696 9.11281L21 12.1504L21 18L0.0393824 11.9026L-2.8975e-07 6.62871L21 0L21 6.07521Z" fill="black"/>
          </svg>
        </button>
        <button>
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
            <path d="M22.2854 17.6428H17.6426V22.2857H22.2854V17.6428Z" fill="#21272A"/>
            <path d="M17.643 13.9287H13.9287V17.643H17.643V13.9287Z" fill="#21272A"/>
            <path d="M25.9999 22.2856H22.2856V25.9999H25.9999V22.2856Z" fill="#21272A"/>
            <path d="M26.0001 13.9287H23.2144V16.7144H26.0001V13.9287Z" fill="#21272A"/>
            <path d="M16.7144 23.2144H13.9287V26.0001H16.7144V23.2144Z" fill="#21272A"/>
            <path d="M22.2854 3.71436H17.6426V8.35721H22.2854V3.71436Z" fill="#21272A"/>
            <path d="M26.0001 12.0714H13.9287V0H26.0001V12.0714ZM16.4823 9.51786H23.4466V2.55357H16.4823V9.51786Z" fill="#21272A"/>
            <path d="M8.35721 3.71436H3.71436V8.35721H8.35721V3.71436Z" fill="#21272A"/>
            <path d="M12.0714 12.0714H0V0H12.0714V12.0714ZM2.55357 9.51786H9.51786V2.55357H2.55357V9.51786Z" fill="#21272A"/>
            <path d="M8.35721 17.6428H3.71436V22.2857H8.35721V17.6428Z" fill="#21272A"/>
            <path d="M12.0714 26.0001H0V13.9287H12.0714V26.0001ZM2.55357 23.4466H9.51786V16.4823H2.55357V23.4466Z" fill="#21272A"/>
          </svg>
        </button>
      </nav>
    ...
    <div class="bg-alphaLight p-4">
        ...
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-lg font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-auto inline mr-2" viewBox="0 0 23 23" fill="none">
              ...
              <path d="M3.98787 11.8882H6.69218C6.80367 12.0002 6.74295 12.1821 6.75621 12.3262C6.99526 14.9169 9.77662 16.7769 12.5021 16.1693C14.3117 15.7659 15.8317 14.3162 16.0907 12.5844C16.1187 12.3968 16.0919 12.1658 16.1208 11.9964C16.1282 11.9529 16.1473 11.9176 16.183 11.8884H18.8873C18.9126 11.9033 18.9202 11.9211 18.9256 11.9476C18.9465 12.0542 18.9353 12.3721 18.9266 12.4934C18.7103 15.4577 16.2473 18.0236 13.1657 18.7041C8.77016 19.6744 4.25499 16.6923 3.94858 12.4932C3.93966 12.3721 3.92843 12.054 3.94961 11.9474C3.95471 11.9209 3.96262 11.9031 3.98787 11.8882Z" fill="white"/>
              <path d="M5.9375 6.90069C6.09403 5.23496 8.039 4.40618 9.20848 5.48572C9.5153 5.76886 9.9375 6.42189 9.9375 6.87518V9.96174L9.90282 10H5.97218L5.9375 9.96174V6.90069Z" fill="white"/>
              <path d="M12.9375 7.96137C13.054 6.61911 14.3766 5.7394 15.4591 6.06963C16.1292 6.27403 16.9375 7.19641 16.9375 8.04237V9.9595L16.9028 10H12.9722L12.9375 9.9595V7.96137Z" fill="white"/>
            </svg>
            My box
          </h2>
      ...
      <div class="py-6 border-b-2 border-gray-200">
        ...
        <div class="grid grid-cols-3 grid-rows-2 gap-2 justify-center">
          ...
          >
            <!-- TODO: Check how many posts -->
            <p class="text-gray-500 text-xs text-center">+5</p>
          </div>
        </div>
      </div>
    </div>
