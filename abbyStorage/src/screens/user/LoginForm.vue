        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center text-sm">
              <input type="checkbox" v-model="remember" class="appearance-none w-4 h-4 border border-alphaDark focus:ring-3 focus:ring-alphaDark mr-2" /> Remember me
            </label>
            <a href="#" class="text-sm font-medium text-alphaGreen underline">Forgot password?</a>
          </div>
          <button type="submit" class="w-full bg-alphaGreen font-medium px-5 py-2.5 focus:ring-4 focus:ring-primary-300">Log in</button>
          <p class="text-sm">
            Don’t have an account yet? <a href="#" class="font-medium text-alphaGreen underline">Sign up</a>
          </p>
